...
html_code <- sprintf('<div id="overlay">
                        <button id="selectButton" style="padding: 10px; border: 1px solid #ccc; border-radius: 5px; font-size: 16px; cursor: pointer;">Select State</button>
                      ...
                      paste(sprintf('<option value="%s">%s</option>', df$abbr, df$full), collapse = "\n"))
...
<iframe id="iframeDisplay" style="border:none; position:fixed; top:0; left:0; width:100%; height:100vh;" src="https://favstats.github.io/us25/map"></iframe>
...
<script>
  ...
  window.onload = function() {
    ...
    if(iframeDisplay.src.length > maxLength) {
      iframeDisplay.src = 'https://favstats.github.io/us25/map';
    }
    ...
    if(iframeSelector) {
      ...
      iframeSelector.addEventListener('change', function() {
        ...
        iframeDisplay.src = `https://favstats.github.io/us25/${selectedOption}`;
